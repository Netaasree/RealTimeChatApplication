    ...
    <main className="font-body relative grid min-h-screen place-items-center overflow-hidden bg-ivory px-4 py-8 transition-colors duration-500 dark:bg-navy">
      ...
      >
        <div className="mb-8 text-center">
          ...
          <p className="text-xs font-black uppercase tracking-[0.24em] text-indigo-500">Welcome back</p>
          <h1 className="mt-2 text-3xl font-black tracking-tight text-slate-900 dark:text-white">
            Sign in to NovaChat
          </h1>
          <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Your conversations are waiting.</p>
        </div>
